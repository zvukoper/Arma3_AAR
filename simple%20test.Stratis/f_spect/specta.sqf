...
spectate_events = compile preprocessFileLineNumbers ("f_spect\specta_events.sqf");
...
RefreshPlayerList = compile preprocessFileLineNumbers "f_spect\RefreshPlayerList.sqf";
FreeLookMovementHandler = compile preprocessFileLineNumbers "f_spect\FreeLookMovementHandler.sqf";
CameraMenuHandler = compile preprocessFileLineNumbers "f_spect\CameraMenuHandler.sqf";
PlayerMenuHandler = compile preprocessFileLineNumbers "f_spect\PlayerMenuHandler.sqf";
...
deletevehicle _bird;
if !( f_var_debugMode == 1 ) then {
	[_player, _killer, "noWait"] execVM ("f_spect\specta.sqf");
};