...
* :black_square_button: Playpack a replay file with ability to spectate, pause and resume.
...
* :black_square_button: Unit and event icons visible when spectating.
...
* :black_square_button: Extended options: what to record, what to playback, simplified playback (no models, no units, only icon moving and shooting).
